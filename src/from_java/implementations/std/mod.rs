    ...
    fn from_java(env: &JnixEnv<'env>, source: JObject<'sub_env>) -> Self {
        ...
        for index in 0..item_count {
            let object = env
                ...
                .expect("Failed to call List.get()")
                .l()
                .expect("Call to List.get() did not return an object");
